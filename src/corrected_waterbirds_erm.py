...
from spuco.datasets import SpuCoCorrectedWaterbirds
...
parser.add_argument("--results_csv", type=str, default="results/corrected_waterbirds_erm.csv")
...
parser.add_argument("--logits_save_dir", type=str, default="logits/corrected_waterbirds")
...
trainset = SpuCoCorrectedWaterbirds(
    root=args.root_dir,
...
valset = SpuCoCorrectedWaterbirds(
    root=args.root_dir,
    label_noise=args.label_noise,
    split="val",
    transform=transform,
...
testset = SpuCoCorrectedWaterbirds(
    root=args.root_dir,
    label_noise=args.label_noise,
    split="test",
    transform=transform,
