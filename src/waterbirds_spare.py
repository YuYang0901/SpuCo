...
parser.add_argument("--cluster_all_classes", action="store_true")
...
if args.pretrained or args.infer_num_epochs > -1:
    ...
    spare_infer = SpareInference(
        ...
        cluster_all_classes=args.cluster_all_classes,
        verbose=True
    )
    ...
    max_f1 = 0
    logits_files = glob(f"logits/waterbirds/lr=0.001_wd=0.0001_seed={args.seed}/trainset*.pt")
    for logits_file in logits_files:
        ...
        if f1 > max_f1:
            ...
            sampling_powers = epoch_sampling_powers
